...
export const RoomChoicesSection = () => {
  return (
    <section id="services" className="flex justify-center items-center w-full bg-dark-background pt-[70px] pb-[130px] md:pt-[80px] md:pb-[130px] lg:py-[70px] lg:pb-[130px]">
