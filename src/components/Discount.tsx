          ...
          <Image
            ...
            <div className="absolute flex flex-col s:flex-row w-full h-full justify-between items-center py-4 px-8 md:px-[65px] xl:px-[100px]">
              ...
              <div className="flex items-center justify-end">
                <button className="flex justify-between lg:w-[150px] lg:justify-center py-[10px] lg:py-[14px] px-[6px] border-y-[1px] border-white items-center gap-[20px] text-white text-[13px] xl:text-[16px] italic">
                  Book Now
